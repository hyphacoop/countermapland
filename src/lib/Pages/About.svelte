...
<ul>
    ...
    <li>   Jamie Lipson </li>
    <li> Kearon Roy Taylor </li>
    <li>  Kevin Henriques </li>
    <li>  Michelle Creeley </li>
    <li>   Monica Hutton </li>
    <li>  Nicole Kelly Westman</li> 
    <li> Tara Marchelewicz </li>
    <li> Victor Temperano</li>
    <li> Syrus Marcus Ware </li>
    <li>    Christina Battle</li>
